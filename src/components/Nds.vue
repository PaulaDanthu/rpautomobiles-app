    ...
    <section class="mt-8">
        <div class="card">
            ...
            <p 
                ...
                mt-4
                mb-8    
            ">4e génération - ND (2015-)</p>
            <div 
                class="
                relative
            ">
                <div v-for="(slide, index) in carouselSlidesNd" :key="carouselSlidesNd.id">
                    <div v-show="currentSlide === index+1">
                        <img :src="`src/assets/ND/${slide.name}.png`" alt="nd" class="img-carousel">
                    </div>
                </div>
                        <!-- Navigation -->
...
setup() {
    ...
    const currentSlide = ref(1)
        ...
        onMounted(() =>  {
            getSlideCount.value = carouselSlidesNd.length
        })
